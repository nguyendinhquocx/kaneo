...
export const taskRunSchema = v.object({
  ...
  runRevision: v.number(),
  taskRevisionAtClaim: v.number(),
  scheduleRevision: v.nullable(v.number()),
  parentRunId: v.nullable(v.string()),
  logicalSessionId: v.nullable(v.string()),
  retryAt: v.nullable(v.date()),
  modelFailed: v.nullable(v.string()),
  failureKind: v.nullable(v.string()),
  attempt: v.number(),
  maxAttempts: v.number(),
  lastCheckpointSha: v.nullable(v.string()),
  lastCommitSha: v.nullable(v.string()),
  finalizationReceipt: v.record(v.string(), v.unknown()),
  manualRecoveryRequired: v.boolean(),
  leaseEpoch: v.number(),
